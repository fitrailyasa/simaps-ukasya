<div id="jadwal" data-id="{{ $jadwal->id }}" gelanggang-id={{$gelanggang->id}} class="hasil-container d-flex text-center
    pr-3 pl-3" style="height: 80vh">
    @php
    $total_merah = 0;
    ...
    <div class="hasil  d-flex justify-content-center flex-column text-center" style="height: 100%;width:24%">
        ...
        <div class="score d-flex justify-content-center" style="height: 20%;width:100%;">
            <div class="button" style="height: 90%;width:60%">
                <div class=""
                    style="height: 100%;width:100%;{{$jadwal->pemenang == $jadwal->PengundianTandingMerah->id ? "
                    border: solid 3px #db3545;background-color: #db3545;"
                    : "border: solid 3px #0053a6;background-color: #0053a6;" }} border-radius: 20px">
                    <p class="text-hasil mt-3 fw-bold" style="font-size: 3rem;color: #fff">{{$jadwal->pemenang ==
                        $jadwal->PengundianTandingMerah->id ? "MERAH" : "BIRU"}}</p>
                </div>
            </div>
        </div>
    ...
    <div class="pesilat-b d-flex justify-content-center flex-column" style="height: 100%;width:38%">
        <div class="image d-flex justify-content-center mb-4" style="height: 20%;width: 100%">
            <img src="{{ $sudut_merah->img == null ? url('/assets/profile/default.webp') :  url('/assets/img/'.$sudut_merah->img) }}"
                alt=""
                style=" margin-top: 4px;height: 150px;width: 150px;border-radius: 50%; background-color: #db3545">
        </div>
        <h1 class="fw-bold" style="color: #db3545">{{$sudut_merah->nama}}</h1>
        <h1 class="fw-bold">{{$sudut_merah->kontingen}}</h1>
        <div class="score d-flex justify-content-center flex-column"
            style="height: 50%;width:100%;border: solid 3px #db3545">
            <p class="text-hasil fw-bold" style="font-size: 18rem;color: #db3545">{{$total_merah}}</p>
        </div>
    </div>
</div>