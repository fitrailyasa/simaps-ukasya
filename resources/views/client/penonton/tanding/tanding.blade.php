<div class="tanding-container p-3 " style="height: 50vh;">
    <div class="tanding-header d-flex" style="height: 20%; width: 100%">
        <div class="pesilat-a d-flex" style="width: 40%">
            ...
            <div class="profile-picture m-1 p-1 text-center" style="height: 100%;width: 11%;border-radius: 50%; background-color: #0053a6">
            ...
            <div class="pesilat-name m-1 p-2 text-center" style="width: 43%">
                <h5 class="fw-bold">Sheikh Alaudin</h5>
                <h3 class="fw-bold" style="color: #0053a6">INDONESIA</h3>
            </div>
        </div>
        <div class="time text-center d-flex flex-column justify-content-center" style="width:20%">
            <div class="d-flex justify-content-center text-center"><h3 class="fw-bold">02:00.</h3><span class="d-flex flex-column justify-content-center mt-1"><h5>00</h5></span></div>
        </div>
        <div class="pesilat-b d-flex" style="width: 40%">
            <div class="pesilat-name m-1 p-2 text-center" style="width: 43%">
                <h5 class="fw-bold">Sheikh Alaudin</h5>
                <h3 class="fw-bold" style="color: #db3545">INDONESIA</h3>
            </div>
            <div class="profile-picture m-1 p-1 text-center" style="height: 100%;width: 11%;border-radius: 50%; background-color: #db3545">
                <img src="{{url('/assets/profile/default.png')}}" alt="" style="height: 90%; margin-top: 4px">
            </div>
    ...
    <div class="tanding-content mt-3 d-flex" style="width: 100%;height: 100%;">
        ...
        <div class="round d-flex flex-column justify-content-center border" style="width: 10%;height: 100%;">
            <div class="box border border-dark" style="height: 15%"></div>
            <div class="box border border-dark" style="height: 15%"></div>
