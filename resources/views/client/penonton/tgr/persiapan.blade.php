...
<img src="{{ $sudut_biru->img == null ? url('/assets/profile/default.png') : url($sudut_biru->img) }}" 
     class="p-4" 
     alt="Profile Image" 
...
<img src="{{ $sudut_merah->img == null ? url('/assets/profile/default.png') : url($sudut_merah->img) }}" 
     class="p-4" 
     alt="Profile Image" 
