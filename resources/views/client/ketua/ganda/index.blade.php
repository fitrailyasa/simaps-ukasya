...
@endsection
@section('content')
    @include('client.penonton.ketua.ganda.navbar',['jenis'=>'GANDA','class'=>'GANDA'])
    ...
    <div class="content-2 d-flex flex-column gap-1 pl-4 pr-4 " style="width:100%;height: 100%">
        <div class="content-left border border-dark d-flex " style="width: 100%;" >
            <div class="indikator" style="width: 30%">
                <div class="time-performance border border-dark pt-2 pl-2 d-flex justify-content-center flex-column" style="width: 100%; height: 38.5%;">
            ...
            <div class="value" style="width: 70%">
                ...
                <div class="sorted-judge d-flex" style="margin-top: -16px;margin-bottom: -16px !important">
                    <div class="juri-1 text-center" style="width: 20%">
                        <div class="juri-1-header border border-dark" style="width: 100%; background-color: #ececec; height: 50%;" >
                            <h6 class="fw-bold">-</h6>
                        </div>
                ...
                <div class="median-value text-center mt-3" style="height: 50%%">
                    <div class="border border-dark ">
                        <h6 class="fw-bold pt-3" style="color: #252c94">0</h6>
                    </div>
                </div>
            </div>
    </div>
