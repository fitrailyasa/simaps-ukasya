<div>
    ...
    if($penalty_solo){
    $penalty = $penalty_solo->toleransi_waktu + $penalty_solo->keluar_arena + $penalty_solo->menyentuh_lantai +
    $penalty_solo->pakaian + $penalty_solo->tidak_bergerak + $penalty_solo->senjata_jatuh;
    } else {
    $penalty = 0;
    }
            ...
            <div class="content-left border border-dark d-flex " style="width: 100%;">
                ...
                <div class="content-right border border-dark" style="width: 50%">
                    <div class="row-1 d-flex" style="width: 100%">
                        ...
                        <div class="nilai border border-dark text-center" style="width: 8%">
                            <h6 class="fw-bold mt-1" style="color: #db3545">
                                {{!$penalty_solo ||$penalty_solo->toleransi_waktu == 0 ? "0" :
                                $penalty_solo->toleransi_waktu * -0.5}}
                            </h6>
                        </div>
                    </div>
                    <div class="row-1 d-flex" style="width: 100%">
                        ...
                        <div class="nilai border border-dark text-center" style="width: 8%">
                            <h6 class="fw-bold mt-1" style="color: #db3545">
                                {{!$penalty_solo || $penalty_solo->keluar_arena == 0 ? "0" : $penalty_solo->keluar_arena
                                * -0.5}}
                            </h6>
                        </div>
                    </div>
                    <div class="row-1 d-flex" style="width: 100%">
                        ...
                        <div class="nilai border border-dark text-center" style="width: 8%">
                            <h6 class="fw-bold mt-1" style="color: #db3545">
                                {{!$penalty_solo ||$penalty_solo->menyentuh_lantai == 0 ? "0" :
                                $penalty_solo->menyentuh_lantai * -0.5}}
                            </h6>
                        </div>
                    </div>
                    <div class="row-1 d-flex" style="width: 100%">
                    ...
                    <div class="row-1 d-flex" style="width: 100%">
                        ...
                        <div class="nilai border border-dark text-center" style="width: 8%">
                            <h6 class="fw-bold mt-1" style="color: #db3545">
                                {{!$penalty_solo ||!$penalty_solo ||$penalty_solo->tidak_bergerak == 0 ? "0" :
                                $penalty_solo->tidak_bergerak * -0.5}}
                            </h6>
                        </div>
                    </div>
                    <div class="row-1 d-flex" style="width: 100%">
                        ...
                        <div class="nilai border border-dark text-center" style="width: 8%">
                            <h6 class="fw-bold mt-1" style="color: #db3545">
                                {{!$penalty_solo ||!$penalty_solo ||$penalty_solo->senjata_jatuh == 0 ? "0" :
                                $penalty_solo->senjata_jatuh * -0.5}}
                            </h6>
                        </div>
                    </div>
                </div>
