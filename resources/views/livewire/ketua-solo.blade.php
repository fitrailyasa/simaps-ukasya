<div>
    @php
    $length = count($penilaian_solo_juri);
    ...
    // Menyortir array penilaian_solo_juri berdasarkan skor dari terkecil ke terbesar
    ...
    <div class="content p-4" style="width:100%;height: auto">
        <div class="content-header d-flex">
            <div class="biru  d-flex justify-content-between p-2 " style="width: 50%">
                <div class="biru-nama">
                    <h5 class="ml-4 fw-bold">{{ $sudut->region }}</h5>
                    <h4 class="fw-bold mt-4" style="color:#252c94">{{ $sudut->nama }}</h4>
                </div>
            </div>
                    ...
                    <div class="border border-dark ">
                        <h6 class="fw-bold pt-3" style="color: #252c94">
                            @if (count($penilaian_solo_juri) % 2 == 0 )
                                    {{($penilaian_solo_juri[$length/2-1]->skor + $penilaian_solo_juri[$length/2]->skor)/2}}
                                @else
                                    {{$penilaian_solo_juri[$length/2-1]->skor}}
                                @endif
                        </h6>
                    </div>
                </div>
