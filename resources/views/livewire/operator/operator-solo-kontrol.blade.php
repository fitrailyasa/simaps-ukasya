...
@endphp
    @section('title')
        kontrol-solo
    @endsection
   <div id="jadwal" data-id="{{ $jadwal_solo->id }}" gelanggang-id={{$gelanggang->id}} class="d-flex justify-content-between align-items-center p-2">
    ...
    <h4 class="fw-bold text-center flex-grow-1 m-0" >
        BABAK {{$jadwal_solo->babak}} {{$jadwal_solo->class}} {{$sudut_biru->kelas}} {{$sudut_biru->golongan}} {{$sudut_biru->jenis_kelamin == 'L' ? "Laki-Laki" : "Perempuan"}}
        <br/>
