<div>
    ...
    if($penalty_ganda){
    $penalty = $penalty_ganda->toleransi_waktu + $penalty_ganda->keluar_arena + $penalty_ganda->menyentuh_lantai +
    $penalty_ganda->pakaian + $penalty_ganda->tidak_bergerak + $penalty_ganda->senjata_jatuh;
    } else {
    $penalty = 0;
    }
    ...
    return $a->skor <=> $b->skor;
        ...
        @endsection
        <div id="jadwal" data-id="{{ $jadwal->id }}" gelanggang-id={{$gelanggang->id}} class="content pl-4 pr-4"
            style="width:100%;height: auto">
            <div class="content-header d-flex">
                <div class="biru  d-flex justify-content-between p-2 " style="width: 50%">
                    <div class="biru-nama">
                        <h5 class="ml-4 fw-bold">{{$tampil['kontingen']}}</h5>
                        <h4 class="fw-bold mt-4" style="{{$tampil['id'] == $sudut_biru['id'] ? " color:#252c94"
                            : "color:#db3545" }}">{{$tampil['nama']}}</h4>
                    </div>
                </div>
            ...
            <div class="content-body d-flex " style="gap: 4px !important; width: 100%; height: auto;">
                ...
                <div class="nilai d-flex gap-1" style="width: 80%; height: 100% !important">
                    ...
                    <div class="nilai-1" style="width: {{100}}%; height: 100%">
                        <div class="nilai-1-header border border-dark text-center pt-2"
                        ...
                        <div class="nilai-1-body mt-1">
                            ...
                            <div class="nilai-1-correctness mt-1">
                                <div class="biru text-center border border-dark pt-2" style="width: 100%">
                                    <h6 class="fw-bold" style="{{$tampil['id'] == $sudut_biru['id'] ? " color:#252c94"
                                        : "color:#db3545" }}">
                                        -
                                    </h6>
                                </div>
                    ...
                    <div class="nilai-1" style="width: {{100/$length}}%; height: 100%">
                        ...
                        <div class="nilai-1-body mt-1">
                            ...
                            <div class="nilai-1-flow mt-1 " style="height: 100% ;">
                                <div class="biru text-center border border-dark pt-2 d-flex flex-column justify-content-center"
                                    style="width: 100%;">
                                    <h6 class="fw-bold" style="color: #252c94">{{$penilaian_juri->soulfulness_skor}}
                                    </h6>
                                </div>
                            </div>
                            <div class="nilai-1-total mt-1">
                                <div class="biru text-center border border-dark pt-2" style="width: 100%">
                                    <h6 class="fw-bold" style="color: #252c94">
                                        {{number_format($penilaian_juri->skor,2)}}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="content-2 d-flex flex-column gap-1 pl-4 pr-4 " style="width:100%;height: 100%">
            <div class="content-left border border-dark d-flex " style="width: 100%;">
                ...
                <div class="value" style="width: 70%">
                    <div class="time-performance d-flex justify-content-between  pb-3"
                    ...
                    <div class="sorted-judge d-flex"
                        style="margin-top: -16px;margin-bottom: -16px !important;height: 46%;">
                        @if (!$sorted_nilai)
                        ...
                        <div class="juri-1 text-center" style="width: {{100/$length}}%">
                            <div class="juri-1-header border border-dark {{($i == $length-1 || $i  == $length) ? "
                            ...
                            <div class="juri-1-value border border-dark {{($i == $length-1 || $i  == $length) ? "
                                bg-success" : "bg-primary" }}" style="width: 100%; height: 32%;">
                                <h6 class="fw-bold">
                        ...
                        @endphp
                        <div class="juri-1 text-center" style="width: {{100/$length}}%">
                            <div class="juri-1-header border border-dark {{( $i  == $length-1) ? " bg-success"
                                : "bg-primary" }}" style="width: 100%; background-color: #ececec; height: 40%;">
                                <h6 class="fw-bold">
                                    {{$juri_name}}
                                </h6>
                            </div>
                            <div class="juri-1-value border border-dark {{( $i  == $length-1) ? " bg-success"
                                : "bg-primary" }}" style="width: 100%; height: 32%;">
                                <h6 class="fw-bold">
                                    {{number_format($nilai->skor,2)}}
                                </h6>
                            </div>
                    ...
                    <div class="median-value text-center border border-dark" style="height: 28% ; margin-top: -28px">
                        <div class="border  ">
                            <h6 class="fw-bold pt-3" style="{{$tampil['id'] == $sudut_biru['id'] ? " color:#252c94"
                                : "color:#db3545" }}">
                ...
                <div class="content-right border border-dark" style="width: 50%">
                    <div class="row-1 d-flex" style="width: 100%">
                        ...
                        <div class="nilai border border-dark text-center" style="width: 8%">
                            <h6 class="fw-bold mt-1" style="color: #db3545">
                                {{!$penalty_ganda ||$penalty_ganda->toleransi_waktu == 0 ? "0" :
                                $penalty_ganda->toleransi_waktu * -0.5}}
                            </h6>
                        </div>
                    </div>
                    <div class="row-1 d-flex" style="width: 100%">
                        ...
                        <div class="nilai border border-dark text-center" style="width: 8%">
                            <h6 class="fw-bold mt-1" style="color: #db3545">
                                {{!$penalty_ganda || $penalty_ganda->keluar_arena == 0 ? "0" :
                                $penalty_ganda->keluar_arena * -0.5}}
                            </h6>
                        </div>
                    </div>
                    <div class="row-1 d-flex" style="width: 100%">
                        ...
                        <div class="nilai border border-dark text-center" style="width: 8%">
                            <h6 class="fw-bold mt-1" style="color: #db3545">
                                {{!$penalty_ganda ||$penalty_ganda->menyentuh_lantai == 0 ? "0" :
                                $penalty_ganda->menyentuh_lantai * -0.5}}
                            </h6>
                        </div>
                    </div>
                    <div class="row-1 d-flex" style="width: 100%">
                        ...
                        <div class="nilai border border-dark text-center" style="width: 8%">
                            <h6 class="fw-bold mt-1" style="color: #db3545">
                                {{!$penalty_ganda ||$penalty_ganda->pakaian == 0 ? "0" : $penalty_ganda->pakaian *
                                -0.5}}
                            </h6>
                        </div>
                    </div>
                    <div class="row-1 d-flex" style="width: 100%">
                        ...
                        <div class="nilai border border-dark text-center" style="width: 8%">
                            <h6 class="fw-bold mt-1" style="color: #db3545">
                                {{!$penalty_ganda ||!$penalty_ganda ||$penalty_ganda->tidak_bergerak == 0 ? "0" :
                                $penalty_ganda->tidak_bergerak * -0.5}}
                            </h6>
                        </div>
                    </div>
                    <div class="row-1 d-flex" style="width: 100%">
                        ...
                        <div class="nilai border border-dark text-center" style="width: 8%">
                            <h6 class="fw-bold mt-1" style="color: #db3545">
                                {{!$penalty_ganda ||!$penalty_ganda ||$penalty_ganda->senjata_jatuh == 0 ? "0" :
                                $penalty_ganda->senjata_jatuh * -0.5}}
                            </h6>
                        </div>
                    </div>
                </div>
