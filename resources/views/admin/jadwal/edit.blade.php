            ...
            <div class="col-md-6">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control @error('partai') is-invalid @enderror"
                        placeholder="partai" name="partai" id="partai" value="{{ $jadwal->partai }}" required>
                    @error('partai')
            ...
            <div class="col-md-6">
                <div class="mb-2">
                    ...
                    <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                        placeholder="tanggal" name="tanggal" id="tanggal" value="{{ $jadwal->tanggal }}" required>
                    @error('tanggal')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control @error('gelanggang') is-invalid @enderror"
                        placeholder="gelanggang" name="gelanggang" id="gelanggang" value="{{ $jadwal->gelanggang }}"
                        required>
                    @error('gelanggang')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <div class="col-md-6">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control @error('babak') is-invalid @enderror" placeholder="babak"
                        name="babak" id="babak" value="{{ $jadwal->babak }}" required>
                    @error('babak')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control @error('kelompok') is-invalid @enderror"
                        placeholder="kelompok" name="kelompok" id="kelompok" value="{{ $jadwal->kelompok }}" required>
                    @error('kelompok')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control @error('pemain_biru') is-invalid @enderror"
                        ...
                        value="{{ $jadwal->pemain_biru }}" required>
                    @error('pemain_biru')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control @error('partai_biru') is-invalid @enderror"
                        ...
                        value="{{ $jadwal->partai_biru }}" required>
                    @error('partai_biru')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control @error('pemain_merah') is-invalid @enderror"
                        ...
                        value="{{ $jadwal->pemain_merah }}" required>
                    @error('pemain_merah')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control @error('partai_merah') is-invalid @enderror"
                        ...
                        value="{{ $jadwal->partai_merah }}" required>
                    @error('partai_merah')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control @error('status') is-invalid @enderror"
                        placeholder="status" name="status" id="status" value="{{ $jadwal->status }}" required>
                    @error('status')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control @error('pemenang') is-invalid @enderror"
                        placeholder="pemenang" name="pemenang" id="pemenang" value="{{ $jadwal->pemenang }}"
                        required>
                    @error('pemenang')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <div class="col-md-6">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control @error('aktif') is-invalid @enderror"
                        placeholder="aktif" name="aktif" id="aktif" value="{{ $jadwal->aktif }}" required>
                    @error('aktif')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
