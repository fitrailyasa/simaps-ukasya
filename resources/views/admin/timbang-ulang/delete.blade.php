...
<a role="button" class="btn-sm btn-danger delete-button" data-bs-toggle="modal"
    data-bs-target=".formEdit{{ $timbangulang->id }}">
    <i class="fa fa-trash"></i>
</a>
<!-- Modal -->
<div class="modal fade formEdit{{ $timbangulang->id }}" tabindex="-1" role="dialog" aria-hidden="">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                @if (auth()->user()->roles_id == 1)
                    <form method="POST" action="{{ route('admin.timbang-ulang.destroy', $timbangulang->id) }}"
