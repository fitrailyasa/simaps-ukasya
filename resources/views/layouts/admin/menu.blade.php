...
<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
            <a href="{{ route('op.gelanggang.index') }}" class="nav-link text-white @yield('table-gelanggang')">
                <i class="nav-icon fas fa-circle"></i>
                <p>
                    Gelanggang
                </p>
        ...
        <li class="nav-item">
            <a href="{{ route('op.user.index') }}" class="nav-link text-white @yield('table-user')">
                <i class="nav-icon fas fa-users"></i>
                <p>
                    User
                </p>
