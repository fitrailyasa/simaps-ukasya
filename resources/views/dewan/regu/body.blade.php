        ...
        <div class="score-body" style="height: 90%;">
            <div class="row-1 d-flex" style="height:20% ">
                ...
                <div class="score-value border border-dark d-flex justify-content-center flex-column" style="width: 20%">
                    <h5 class="fw-bold">{{$penalty_regu->toleransi_waktu == 0 ? "0" : $penalty_regu->toleransi_waktu * -0.5}}</h5>
                </div>
            </div>
            <div class="row-2 d-flex" style="height:20% ">
                ...
                <div class="score-value border border-dark  d-flex justify-content-center flex-column" style="width: 20%">
                    <h5 class="fw-bold">{{$penalty_regu->keluar_arena == 0 ? "0" : $penalty_regu->keluar_arena * -0.5}}</h5>
                </div>
            </div>
            <div class="row-3 d-flex" style="height:20% ">
                ...
                <div class="score-value border border-dark d-flex justify-content-center flex-column" style="width: 20%">
                    <h5 class="fw-bold">{{$penalty_regu->menyentuh_lantai == 0 ? "0" : $penalty_regu->menyentuh_lantai * -0.5}}</h5>
                </div>
            </div>
            <div class="row-4 d-flex" style="height:20% ">
                ...
                <div class="score-value border border-dark d-flex justify-content-center flex-column" style="width: 20%">
                    <h5 class="fw-bold">{{$penalty_regu->pakaian == 0 ? "0" : $penalty_regu->pakaian * -0.5}}</h5>
                </div>
            </div>
            <div class="row-5 d-flex" style="height:20% ">
                <div class="button d-flex justify-content-center gap-2 border border-dark" style="width: 80%">
                 ...
                 <div class="score-value border border-dark d-flex justify-content-center flex-column" style="width: 20%">
                    <h5 class="fw-bold">{{$penalty_regu->tidak_bergerak == 0 ? "0" : $penalty_regu->tidak_bergerak * -0.5}}</h5>
                </div>
            </div>
        </div>
    </div>
