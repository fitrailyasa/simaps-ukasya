<div id="jadwal" data-id="{{ $jadwal->id }}" gelanggang-id={{$gelanggang->id}} class="tunggal-body d-flex gap-1 border text-center" style="width: 100%;height: 60vh;">
        ...
        <div class="score-body" style="height: 90%;">
            <div class="row-1 d-flex" style="height:16.67% ">
                ...
                <div class="score-value border border-dark d-flex justify-content-center flex-column" style="width: 20%">
                    <h5 class="fw-bold">{{$penalty_solo->toleransi_waktu == 0 ? "0" : $penalty_solo->toleransi_waktu * -0.5}}</h5>
                </div>
            </div>
            <div class="row-2 d-flex" style="height:16.67% ">
                ...
                <div class="score-value border border-dark  d-flex justify-content-center flex-column" style="width: 20%">
                    <h5 class="fw-bold">{{$penalty_solo->keluar_arena == 0 ? "0" : $penalty_solo->keluar_arena * -0.5}}</h5>
                </div>
            </div>
            <div class="row-3 d-flex" style="height:16.67% ">
                ...
                <div class="score-value border border-dark d-flex justify-content-center flex-column" style="width: 20%">
                    <h5 class="fw-bold">{{$penalty_solo->menyentuh_lantai == 0 ? "0" : $penalty_solo->menyentuh_lantai * -0.5}}</h5>
                </div>
            </div>
            <div class="row-4 d-flex" style="height:16.67% ">
                ...
                <div class="score-value border border-dark d-flex justify-content-center flex-column" style="width: 20%">
                    <h5 class="fw-bold">{{$penalty_solo->pakaian == 0 ? "0" : $penalty_solo->pakaian * -0.5}}</h5>
                </div>
            </div>
            <div class="row-5 d-flex" style="height:16.67% ">
                <div class="button d-flex justify-content-center gap-2 border border-dark" style="width: 80%">
                 ...
                 <div class="score-value border border-dark d-flex justify-content-center flex-column" style="width: 20%">
                    <h5 class="fw-bold">{{$penalty_solo->tidak_bergerak == 0 ? "0" : $penalty_solo->tidak_bergerak * -0.5}}</h5>
                </div>
            </div>
            <div class="row-6 d-flex" style="height:16.67% ">
                ...
                <div class="score-value border border-dark d-flex justify-content-center flex-column" style="width: 20%">
                    <h5 class="fw-bold">{{$penalty_solo->senjata_jatuh == 0 ? "0" : $penalty_solo->senjata_jatuh * -0.5}}</h5>
                </div>
            </div>
        </div>
    </div>
