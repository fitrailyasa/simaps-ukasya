<div class="tombol-container d-flex mt-3" style="width: 100%;height: 40vh;">
    <div class="tombol-pesilat-a" style="width: 45%; height: 100%">
        <div class="tombol d-flex gap-1 mt-2" style="width: 100%; height: 70%">
            <div class="tombol-1" style="width: 33%;height: 100%;">
                <button wire:click.prevent="tambahJatuhanTrigger({{$sudut_biru->id}})" class="btn btn-biru mb-4 btn-jatuhan-a" style="border-radius: 20px !important ;border: 2px solid black; height: 40%; width: 100%"><h5 class="fw-bold">Jatuhan</h5></button>
    ...
    <div class="tombol-pesilat-b" style="width: 45%">
      <div class="tombol d-flex gap-1 mt-2" style="width: 100%; height: 70%">
            ...
            <div class="tombol-3" style="width: 33%;height: 100%;">
                <button wire:click.prevent="tambahJatuhanTrigger({{$sudut_merah->id}})" class="btn btn-danger mb-4 btn-jatuhan-b" style="border-radius: 20px !important ;border: 2px solid black; height: 40%; width: 100%"><h5 class="fw-bold">Jatuhan</h5></button>
