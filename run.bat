...
start "PHP Server" cmd /k "cd /d C:\Users\fadil\Desktop\simaps-ukaya && php artisan serve --host=192.168.0.101"

:: Menjalankan PHP artisan reverb:start dengan host dan port tertentu
start "Reverb" cmd /k "cd /d C:\Users\fadil\Desktop\simaps-ukaya && php artisan reverb:start --host=192.168.0.101 --port=9000"
